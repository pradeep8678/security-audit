...
import { GetIpamPolicyAllocationRulesRequest, GetIpamPolicyAllocationRulesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamPolicyAllocationRulesCommand_base: {
    new (input: GetIpamPolicyAllocationRulesCommandInput): import("@smithy/smithy-client").CommandImpl<GetIpamPolicyAllocationRulesCommandInput, GetIpamPolicyAllocationRulesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIpamPolicyAllocationRulesCommandInput): import("@smithy/smithy-client").CommandImpl<GetIpamPolicyAllocationRulesCommandInput, GetIpamPolicyAllocationRulesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
