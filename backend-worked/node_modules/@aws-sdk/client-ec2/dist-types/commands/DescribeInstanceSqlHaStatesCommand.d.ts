...
import { DescribeInstanceSqlHaStatesRequest, DescribeInstanceSqlHaStatesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceSqlHaStatesCommand_base: {
    new (input: DescribeInstanceSqlHaStatesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeInstanceSqlHaStatesCommandInput, DescribeInstanceSqlHaStatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceSqlHaStatesCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeInstanceSqlHaStatesCommandInput, DescribeInstanceSqlHaStatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
