...
import { CreateTransitGatewayMeteringPolicyEntryRequest, CreateTransitGatewayMeteringPolicyEntryResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayMeteringPolicyEntryCommand_base: {
    new (input: CreateTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTransitGatewayMeteringPolicyEntryCommandInput, CreateTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTransitGatewayMeteringPolicyEntryCommandInput, CreateTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
