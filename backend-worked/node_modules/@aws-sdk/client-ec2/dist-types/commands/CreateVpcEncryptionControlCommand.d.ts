...
import { CreateVpcEncryptionControlRequest, CreateVpcEncryptionControlResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateVpcEncryptionControlCommand_base: {
    new (input: CreateVpcEncryptionControlCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVpcEncryptionControlCommandInput, CreateVpcEncryptionControlCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateVpcEncryptionControlCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVpcEncryptionControlCommandInput, CreateVpcEncryptionControlCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
