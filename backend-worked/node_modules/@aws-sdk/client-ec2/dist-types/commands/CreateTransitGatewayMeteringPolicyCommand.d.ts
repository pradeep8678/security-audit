...
import { CreateTransitGatewayMeteringPolicyRequest, CreateTransitGatewayMeteringPolicyResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateTransitGatewayMeteringPolicyCommand_base: {
    new (input: CreateTransitGatewayMeteringPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTransitGatewayMeteringPolicyCommandInput, CreateTransitGatewayMeteringPolicyCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateTransitGatewayMeteringPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTransitGatewayMeteringPolicyCommandInput, CreateTransitGatewayMeteringPolicyCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
