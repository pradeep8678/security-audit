...
import { DescribeInstanceSqlHaHistoryStatesRequest, DescribeInstanceSqlHaHistoryStatesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeInstanceSqlHaHistoryStatesCommand_base: {
    new (input: DescribeInstanceSqlHaHistoryStatesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeInstanceSqlHaHistoryStatesCommandInput, DescribeInstanceSqlHaHistoryStatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceSqlHaHistoryStatesCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeInstanceSqlHaHistoryStatesCommandInput, DescribeInstanceSqlHaHistoryStatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
