...
import { GetIpamPolicyOrganizationTargetsRequest, GetIpamPolicyOrganizationTargetsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetIpamPolicyOrganizationTargetsCommand_base: {
    new (input: GetIpamPolicyOrganizationTargetsCommandInput): import("@smithy/smithy-client").CommandImpl<GetIpamPolicyOrganizationTargetsCommandInput, GetIpamPolicyOrganizationTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIpamPolicyOrganizationTargetsCommandInput): import("@smithy/smithy-client").CommandImpl<GetIpamPolicyOrganizationTargetsCommandInput, GetIpamPolicyOrganizationTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
