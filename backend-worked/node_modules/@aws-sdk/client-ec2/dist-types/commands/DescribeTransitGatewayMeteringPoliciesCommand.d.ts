...
import { DescribeTransitGatewayMeteringPoliciesRequest, DescribeTransitGatewayMeteringPoliciesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeTransitGatewayMeteringPoliciesCommand_base: {
    new (input: DescribeTransitGatewayMeteringPoliciesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayMeteringPoliciesCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
