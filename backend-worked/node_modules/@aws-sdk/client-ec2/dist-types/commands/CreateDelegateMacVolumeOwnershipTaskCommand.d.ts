...
import { CreateDelegateMacVolumeOwnershipTaskRequest, CreateDelegateMacVolumeOwnershipTaskResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDelegateMacVolumeOwnershipTaskCommand_base: {
    new (input: CreateDelegateMacVolumeOwnershipTaskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDelegateMacVolumeOwnershipTaskCommandInput, CreateDelegateMacVolumeOwnershipTaskCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateDelegateMacVolumeOwnershipTaskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDelegateMacVolumeOwnershipTaskCommandInput, CreateDelegateMacVolumeOwnershipTaskCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
