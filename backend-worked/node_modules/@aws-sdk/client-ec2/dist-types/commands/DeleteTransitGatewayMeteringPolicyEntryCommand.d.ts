...
import { DeleteTransitGatewayMeteringPolicyEntryRequest, DeleteTransitGatewayMeteringPolicyEntryResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteTransitGatewayMeteringPolicyEntryCommand_base: {
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
